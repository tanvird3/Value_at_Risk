...
Original file is located at
    https://colab.research.google.com/drive/1hFmQ7rq7BLY5f7puWXNyXGPMN8mTHe19
"""
...
def VaR(startdate, enddate, portfolio):
    ...
    var_col = np.append([VaR], VaR_next)

    output = pd.DataFrame({'Days': days_col, 'VaR_PCT': var_pct, 'VaR': var_col})
